...
?>
	...
	<article>
		...
		<em style="text-align:right;">Le <?php echo html_escape($news->offsetGet('add_date')->format('d/m/Y à H:i')); ?> par <?php // echo html_escape($news->offsetGet('author')->offsetGet('username')); ?>.</em>
