...
<html>
        <head>
			...
			<!-- Feuilles de style -->
			<link rel="stylesheet" href="/Project_Web_Site/Applications/Backend/Styles/Default/CSS/Global.css" />
        ...
        <body>
			<nav>
				<ul style="float: left;">
					<li><a href="<?php echo $config->getItem(CFG_GENERAL, 'base_url').'admin/news'; ?>">News</a></li>
					<li><a href="<?php echo $config->getItem(CFG_GENERAL, 'base_url').'admin/pages'; ?>">Pages</a></li>
				</ul>
