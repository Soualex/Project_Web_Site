...
namespace System\Library\Models\Files;

if (!defined('BASEPATH')) exit('No direct script access allowed');
 
use \System\Library\Models\Files\Files;
...
class FilesManager_PDO extends FilesManager
{
	public function getList($debut = -1, $limite = -1) 
	{
		...
		$query->setFetchMode(\PDO::FETCH_CLASS | \PDO::FETCH_PROPS_LATE, '\System\Library\Models\Files\Files');
	...
	public function add(\System\Library\Models\Files\Files $file) 
	{		
