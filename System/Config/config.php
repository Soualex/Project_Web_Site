...
|--------------------------------------------------------------------------
|
| URL to your Framework root. Typically this will be your base URL,
...
|--------------------------------------------------------------------------
|
| This option allows you to add a suffix to all URLs generated by this Framework.
|
*/
...
if(file_exists("system/config/encryption_key.php"))
{
	require_once("system/config/encryption_key.php");
}
else
{
	...
	$file = fopen("system/config/encryption_key.php", "w");
...
|
*/
$config['sess_cookie_name']		= 'site-v2_';
$config['sess_expiration']		= time() + 18000;
...
$config['sess_time_to_update']	= time() + 18000;
