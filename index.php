 ...
 *---------------------------------------------------------------
 *
 * If you want this front controller to use a different "Applications"
 ...
 *---------------------------------------------------------------
 *
 * If you want this front controller to use a different "Errors"
 * folder then the default one you can set its name here. The folder
 * can also be renamed or relocated anywhere on your server.  If
 * you do, use a full server path.
 *
 ...
 */
	...
	if (realpath($errors_folder) !== FALSE)
	{
		$errors_folder = realpath($errors_folder).'/';
	}

	// ensure there's a trailing slash
	$errors_folder = rtrim($errors_folder, '/').'/';
	
	if (is_dir($errors_folder))
	{
		define('ERRORSPATH', str_replace("\\", "/", $errors_folder));
	}
	else
	{
